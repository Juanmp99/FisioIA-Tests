...
export async function enviarAcceso({ correo, enlace }) {
  ...
  const asunto = "🎉 Tu acceso a Exploración guiada está aquí";

  const texto = [
    "¡Ya tienes tu acceso! Exploración guiada está lista para que la uses.",
    "",
    "Entra desde aquí:",
    enlace,
    "",
  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f5f7fb;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;background:#ffffff;border-radius:14px;padding:36px 32px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;color:#0f2740;">
        ...
        <tr><td style="padding-bottom:24px;font-size:15px;color:#5b6478;">Exploración guiada</td></tr>
        ...
        <tr><td style="font-size:15px;line-height:1.6;color:#333b4a;padding-bottom:26px;">
          Tu copiloto a pie de camilla. Escribe tu sospecha y tienes la exploración resuelta:
          qué tests hacer, cómo se ejecuta cada uno, cuánto puedes fiarte de lo que te salga
          y qué puedes concluir. Con la evidencia publicada delante.
        </td></tr>
        <tr><td align="center" style="padding-bottom:26px;">
          <a href="${enlace}" style="display:inline-block;background:#00a97f;color:#ffffff;text-decoration:none;font-weight:600;font-size:16px;padding:14px 30px;border-radius:10px;">Abrir Exploración guiada &rarr;</a>
        </td></tr>
